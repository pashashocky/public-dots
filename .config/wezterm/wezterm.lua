...
local smart_path = "/Users/pash/.local/share/smart-splits.nvim"
...
config.font = wezterm.font("Liga Hack")
config.font_size = 13
...
config.keys = {
	...
	{ key = "l", mods = "ALT|SHIFT", action = act.ShowLauncherArgs({ flags = "FUZZY|WORKSPACES" }) },
	{
		key = "u",
		mods = "ALT|SHIFT",
...
smart_splits.apply_to_config(config, {
	...
	modifiers = {
		move = "ALT|SHIFT", -- modifier to use for pane movement, e.g. CTRL+h to move left
		resize = "ALT|SHIFT", -- modifier to use for pane resize, e.g. META+h to resize to the left
	},
